...
const translations = {
    es: {
        ...
        'contact-phone': '<strong>📞 Teléfono:</strong> +54 (11) 6463 5474',
        'contact-location': '<strong>📍 Ubicación:</strong> Correa 3030, 3B, CABA. Argentina',
        ...
        'staffing-models-title': 'Modelos de Staffing',
        'staffing-models-subtitle': 'Flexibilidad total para adaptarse a tus necesidades de proyecto',
        'staffing-model1-title': 'Staff Augmentation',
        'staffing-model1-li1': 'Recursos bajo tu gestión directa',
        'staffing-model1-li2': 'Integración total con tu equipo',
        'staffing-model1-li3': 'Flexibilidad de duración',
        'staffing-model1-li4': 'Control completo del proyecto',
        'staffing-model2-title': 'Project-Based Teams',
        'staffing-model2-li1': 'Equipos completos pre-armados',
        'staffing-model2-li2': 'Metodología y PM incluidos',
        'staffing-model2-li3': 'Entrega end-to-end',
        'staffing-model2-li4': 'Fixed-price o time & material',
        'staffing-model3-title': 'Rapid Deployment',
        'staffing-model3-li1': 'Recursos inmediatos (24-48h)',
        'staffing-model3-li2': 'Para urgencias y crisis',
        'staffing-model3-li3': 'Especialistas senior disponibles',
        'staffing-model3-li4': 'Soporte 24/7 si necesario',
        'staffing-model4-title': 'Long-term Partnership',
        'staffing-model4-li1': 'Recursos dedicados por años',
        'staffing-model4-li2': 'Crecimiento junto a tu negocio',
        'staffing-model4-li3': 'Knowledge retention',
        'staffing-model4-li4': 'Rates preferenciales',
        'staffing-model5-title': 'Training & Development',
        'staffing-model5-li1': 'Upskilling de equipos internos',
        'staffing-model5-li2': 'Mentoring y knowledge transfer',
        'staffing-model5-li3': 'Certificaciones SAP',
        'staffing-model5-li4': 'Best practices workshops',
        'staffing-model6-title': 'Executive Search',
        'staffing-model6-li1': 'CTO, SAP Directors, Managers',
        'staffing-model6-li2': 'Proceso de headhunting completo',
        'staffing-model6-li3': 'Assessment técnico y cultural',
        'staffing-model6-li4': 'Garantía de reemplazo',
        'staffing-profiles-title': 'Perfiles de Talento Disponibles',
        'staffing-profile1-title': 'Solution Architects',
        'staffing-profile1-desc': 'Diseño de arquitecturas SAP enterprise',
        'staffing-profile2-title': 'ABAP Developers',
        'staffing-profile2-desc': 'Desarrollo y customización avanzada',
        'staffing-profile3-title': 'Fiori/UI5 Experts',
        'staffing-profile3-desc': 'Especialistas en experiencia de usuario',
        'staffing-profile4-title': 'Integration Specialists',
        'staffing-profile4-desc': 'Conectividad y APIs SAP/no-SAP',
        'staffing-profile5-title': 'Functional Consultants',
        'staffing-profile5-desc': 'Expertos en procesos de negocio',
        'staffing-profile6-title': 'Project Managers',
        'staffing-profile6-desc': 'Gestión de proyectos SAP complejos',
        'staffing-cases-title': 'Casos de Éxito en Staffing',
        'staffing-case1-title': 'Equipo S/4 HANA Manufacturera',
        'staffing-case1-challenge': 'Desafío: Migración S/4 HANA en 18 meses con equipo reducido',
        'staffing-case1-solution': 'Solución: Team de 8 consultores senior especializados en manufacturing',
        'staffing-case1-benefit1': 'Go-live on time',
        'staffing-case1-benefit2': '0 issues críticos',
        'staffing-case1-benefit3': 'Team retained post go-live',
        'staffing-case2-title': 'ABAP Developer Crisis Support',
        'staffing-case2-challenge': 'Desafío: Desarrollador clave renunció durante implementación crítica',
        'staffing-case2-solution': 'Solución: ABAP Senior con experiencia en el mismo módulo en 24h',
        'staffing-case2-benefit1': 'Onboarding 48h',
        'staffing-case2-benefit2': 'No project delay',
        'staffing-case2-benefit3': 'Seamless transition',
        'staffing-case3-title': 'BTP Specialized Team',
        'staffing-case3-challenge': 'Desafío: Necesidad de expertise en SAP BTP para innovación',
        'staffing-case3-solution': 'Solución: Equipo especializado en BTP, AI y integration',
        'staffing-case3-benefit1': '3 apps BTP delivered',
        'staffing-case3-benefit2': 'Knowledge transfer completo',
        'staffing-case3-benefit3': 'Internal team upskilled',
        'staffing-case4-title': 'SAP Director Placement',
        'staffing-case4-challenge': 'Desafío: Búsqueda de Director SAP para liderar transformación',
        'staffing-case4-solution': 'Solución: Executive search con assessment técnico y de liderazgo',
        'staffing-case4-benefit1': 'Hired in 6 weeks',
        'staffing-case4-benefit2': 'Perfect cultural fit',
        'staffing-case4-benefit3': 'Transformation success',
        'staffing-process-title': 'Proceso de Staffing',
        'staffing-step1-title': 'Requirements Analysis',
        'staffing-step1-desc': 'Entendemos tus necesidades técnicas, de negocio y cultura organizacional',
        'staffing-step1-duration': '24-48h',
        'staffing-step2-title': 'Talent Matching',
        'staffing-step2-desc': 'Screening inicial y selección de candidatos que mejor se ajusten al perfil',
        'staffing-step2-duration': '1-3 días',
        'staffing-step3-title': 'Technical Assessment',
        'staffing-step3-desc': 'Evaluación técnica profunda y validación de experiencia práctica',
        'staffing-step3-duration': '2-5 días',
        'staffing-step4-title': 'Client Interview',
        'staffing-step4-desc': 'Presentación de candidatos y facilitación del proceso de entrevista',
        'staffing-step4-duration': '1 semana',
        'staffing-step5-title': 'Onboarding & Support',
        'staffing-step5-desc': 'Facilitamos la integración y brindamos soporte continuo',
        'staffing-step5-duration': 'Ongoing',
        'staffing-why-title': '¿Por qué elegir nuestro Staffing?',
        'staffing-why1-title': 'Especialización SAP',
        'staffing-why1-text': '100% enfocados en talento SAP con deep understanding del ecosistema',
        'staffing-why2-title': 'Speed to Market',
        'staffing-why2-text': 'Procesos optimizados para colocaciones rápidas sin sacrificar calidad',
        'staffing-why3-title': 'Partnership Approach',
        'staffing-why3-text': 'No somos solo recruiters, somos partners estratégicos en tu crecimiento',
        'staffing-why4-title': 'Quality Assurance',
        'staffing-why4-text': 'Assessment técnico riguroso y garantías de performance',
        'staffing-why5-title': 'Network Extenso',
        'staffing-why5-text': 'Red de +500 profesionales SAP activos en Latinoamérica',
        'staffing-why6-title': 'Talent Retention',
        'staffing-why6-text': '95% de retención gracias a excellent matching y ongoing support',
        'staffing-pricing-title': 'Modelos de Precios',
        'staffing-pricing-subtitle': 'Transparencia total en nuestros modelos de engagement',
        'staffing-price1-title': 'Contingency Fee',
        'staffing-price1-li1': 'Pago solo por colocación exitosa',
        'staffing-price1-li2': '15-25% del salario anual',
        'staffing-price1-li3': 'Garantía de reemplazo 90 días',
        'staffing-price1-li4': 'Ideal para posiciones permanentes',
        'staffing-price2-title': 'Retained Search',
        'staffing-price2-li1': 'Proceso dedicado y exclusivo',
        'staffing-price2-li2': 'Pago en milestones',
        'staffing-price2-li3': 'Para posiciones executive',
        'staffing-price2-li4': 'Research y assessment profundo',
        'staffing-price3-title': 'Staff Augmentation',
        'staffing-price3-li1': 'Rate mensual por consultor',
        'staffing-price3-li2': 'Markup transparente',
        'staffing-price3-li3': 'Facturación directa',
        'staffing-price3-li4': 'Flexibilidad de scaling',
        'staffing-price4-title': 'Project-Based',
        'staffing-price4-li1': 'Fixed-price por deliverable',
        'staffing-price4-li2': 'Scope bien definido',
        'staffing-price4-li3': 'Gestión de riesgo incluida',
        'staffing-price4-li4': 'Penalties por delays',
        ...
        'social-title': 'Síguenos en:',
        'linkedin-text': 'LinkedIn',
        'instagram-text': 'Instagram',
        'cessi-desc': 'Miembro de CESSI - Cámara de la Industria Argentina del Software',
        'sap-partner-desc': 'SAP products and services mentioned herein as well as their respective logos are trademarks or registered trademarks of their respective owners',
    },
    en: {
        'nav-home': 'Home',
        'nav-about': 'About Us',
        ...
        'contact-email': '<strong>📧 Email:</strong> info@altromondo.com.ar',
        'contact-phone': '<strong>📞 Phone:</strong> +54 (11) 6463 5474',
        'contact-location': '<strong>📍 Location:</strong> Correa 3030, 3B, CABA. Argentina',
        'form-name': 'Full Name',
        ...
        'staffing-models-title': 'Staffing Models',
        'staffing-models-subtitle': 'Complete flexibility to fit your project needs',
        'staffing-model1-title': 'Staff Augmentation',
        'staffing-model1-li1': 'Resources under your direct management',
        'staffing-model1-li2': 'Full integration with your team',
        'staffing-model1-li3': 'Flexible duration',
        'staffing-model1-li4': 'Full project control',
        'staffing-model2-title': 'Project-Based Teams',
        'staffing-model2-li1': 'Pre-assembled complete teams',
        'staffing-model2-li2': 'Methodology and PM included',
        'staffing-model2-li3': 'End-to-end delivery',
        'staffing-model2-li4': 'Fixed-price or time & material',
        'staffing-model3-title': 'Rapid Deployment',
        'staffing-model3-li1': 'Immediate resources (24-48h)',
        'staffing-model3-li2': 'For emergencies and crises',
        'staffing-model3-li3': 'Senior specialists available',
        'staffing-model3-li4': '24/7 support if needed',
        'staffing-model4-title': 'Long-term Partnership',
        'staffing-model4-li1': 'Resources dedicated for years',
        'staffing-model4-li2': 'Growth alongside your business',
        'staffing-model4-li3': 'Knowledge retention',
        'staffing-model4-li4': 'Preferential rates',
        'staffing-model5-title': 'Training & Development',
        'staffing-model5-li1': 'Upskilling of internal teams',
        'staffing-model5-li2': 'Mentoring and knowledge transfer',
        'staffing-model5-li3': 'SAP certifications',
        'staffing-model5-li4': 'Best practices workshops',
        'staffing-model6-title': 'Executive Search',
        'staffing-model6-li1': 'CTO, SAP Directors, Managers',
        'staffing-model6-li2': 'Full headhunting process',
        'staffing-model6-li3': 'Technical and cultural assessment',
        'staffing-model6-li4': 'Replacement guarantee',
        'staffing-profiles-title': 'Available Talent Profiles',
        'staffing-profile1-title': 'Solution Architects',
        'staffing-profile1-desc': 'Design of SAP enterprise architectures',
        'staffing-profile2-title': 'ABAP Developers',
        'staffing-profile2-desc': 'Advanced development and customization',
        'staffing-profile3-title': 'Fiori/UI5 Experts',
        'staffing-profile3-desc': 'User experience specialists',
        'staffing-profile4-title': 'Integration Specialists',
        'staffing-profile4-desc': 'Connectivity and SAP/non-SAP APIs',
        'staffing-profile5-title': 'Functional Consultants',
        'staffing-profile5-desc': 'Business process experts',
        'staffing-profile6-title': 'Project Managers',
        'staffing-profile6-desc': 'Management of complex SAP projects',
        'staffing-cases-title': 'Staffing Success Stories',
        'staffing-case1-title': 'S/4 HANA Manufacturing Team',
        'staffing-case1-challenge': 'Challenge: S/4 HANA migration in 18 months with a small team',
        'staffing-case1-solution': 'Solution: Team of 8 senior consultants specialized in manufacturing',
        'staffing-case1-benefit1': 'Go-live on time',
        'staffing-case1-benefit2': 'No critical issues',
        'staffing-case1-benefit3': 'Team retained post go-live',
        'staffing-case2-title': 'ABAP Developer Crisis Support',
        'staffing-case2-challenge': 'Challenge: Key developer resigned during critical implementation',
        'staffing-case2-solution': 'Solution: Senior ABAP with same module experience in 24h',
        'staffing-case2-benefit1': 'Onboarding 48h',
        'staffing-case2-benefit2': 'No project delay',
        'staffing-case2-benefit3': 'Seamless transition',
        'staffing-case3-title': 'BTP Specialized Team',
        'staffing-case3-challenge': 'Challenge: Need expertise in SAP BTP for innovation',
        'staffing-case3-solution': 'Solution: Team specialized in BTP, AI and integration',
        'staffing-case3-benefit1': '3 BTP apps delivered',
        'staffing-case3-benefit2': 'Complete knowledge transfer',
        'staffing-case3-benefit3': 'Internal team upskilled',
        'staffing-case4-title': 'SAP Director Placement',
        'staffing-case4-challenge': 'Challenge: Searching for SAP Director to lead transformation',
        'staffing-case4-solution': 'Solution: Executive search with technical and leadership assessment',
        'staffing-case4-benefit1': 'Hired in 6 weeks',
        'staffing-case4-benefit2': 'Perfect cultural fit',
        'staffing-case4-benefit3': 'Transformation success',
        'staffing-process-title': 'Staffing Process',
        'staffing-step1-title': 'Requirements Analysis',
        'staffing-step1-desc': 'We understand your technical, business and cultural needs',
        'staffing-step1-duration': '24-48h',
        'staffing-step2-title': 'Talent Matching',
        'staffing-step2-desc': 'Initial screening and selection of best-fit candidates',
        'staffing-step2-duration': '1-3 days',
        'staffing-step3-title': 'Technical Assessment',
        'staffing-step3-desc': 'In-depth technical evaluation and validation of practical experience',
        'staffing-step3-duration': '2-5 days',
        'staffing-step4-title': 'Client Interview',
        'staffing-step4-desc': 'Candidate presentation and interview facilitation',
        'staffing-step4-duration': '1 week',
        'staffing-step5-title': 'Onboarding & Support',
        'staffing-step5-desc': 'We facilitate integration and provide continuous support',
        'staffing-step5-duration': 'Ongoing',
        'staffing-why-title': 'Why Choose Our Staffing?',
        'staffing-why1-title': 'SAP Specialization',
        'staffing-why1-text': '100% focused on SAP talent with deep ecosystem understanding',
        'staffing-why2-title': 'Speed to Market',
        'staffing-why2-text': 'Optimized processes for fast placements without sacrificing quality',
        'staffing-why3-title': 'Partnership Approach',
        'staffing-why3-text': 'We are not just recruiters, but strategic partners in your growth',
        'staffing-why4-title': 'Quality Assurance',
        'staffing-why4-text': 'Rigorous technical assessment and performance guarantees',
        'staffing-why5-title': 'Extensive Network',
        'staffing-why5-text': 'Network of 500+ active SAP professionals in Latin America',
        'staffing-why6-title': 'Talent Retention',
        'staffing-why6-text': '95% retention thanks to excellent matching and ongoing support',
        'staffing-pricing-title': 'Pricing Models',
        'staffing-pricing-subtitle': 'Full transparency in our engagement models',
        'staffing-price1-title': 'Contingency Fee',
        'staffing-price1-li1': 'Pay only upon successful placement',
        'staffing-price1-li2': '15-25% of annual salary',
        'staffing-price1-li3': '90-day replacement guarantee',
        'staffing-price1-li4': 'Ideal for permanent positions',
        'staffing-price2-title': 'Retained Search',
        'staffing-price2-li1': 'Dedicated and exclusive process',
        'staffing-price2-li2': 'Milestone-based payment',
        'staffing-price2-li3': 'For executive positions',
        'staffing-price2-li4': 'Deep research and assessment',
        'staffing-price3-title': 'Staff Augmentation',
        'staffing-price3-li1': 'Monthly rate per consultant',
        'staffing-price3-li2': 'Transparent markup',
        'staffing-price3-li3': 'Direct billing',
        'staffing-price3-li4': 'Scalable flexibility',
        'staffing-price4-title': 'Project-Based',
        'staffing-price4-li1': 'Fixed price per deliverable',
        'staffing-price4-li2': 'Well-defined scope',
        'staffing-price4-li3': 'Risk management included',
        'staffing-price4-li4': 'Penalties for delays',
        'sap-btp-hero-title': 'SAP Business Technology Platform (BTP)',
        ...
        'linkedin-text': 'LinkedIn',
        'instagram-text': 'Instagram',
        'cessi-desc': 'CESSI Member - Argentine Software Industry Chamber',
        'sap-partner-desc': 'SAP products and services mentioned herein as well as their respective logos are trademarks or registered trademarks of their respective owners',
    }
};
